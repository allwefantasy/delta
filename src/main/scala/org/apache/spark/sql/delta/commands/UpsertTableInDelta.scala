...
/**
 * This class is used to upsert/delete delta table. You can specify `operation`
 * in configuration to tell it to execute upsert or delete action.
 * Notice that the _data should not too big otherwize the performance may slow down quickly.
 *
 *
 * @param _data
 * @param saveMode
